...
public final class SftpKit {
	...
	public static void main(String[] args) {
		try {
			...
			SftpKit.upload(sftp, new File("C:\\Users\\com.mrathena\\Desktop\\java开发手册[华山版][1.5.0].pdf"), "/upload");
			SftpKit.download(sftp, "/upload/java开发手册[华山版][1.5.0].pdf", new File("C:\\Users\\com.mrathena\\Desktop\\aaaaaaa.pdf"));
