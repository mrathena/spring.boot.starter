...
public final class CheckKit {
	...
	public static void needNotNull(Object argument, String name) {
		if (null == argument) {
			throw new ServiceException(ExceptionCodeEnum.ILLEGAL_ARGUMENT.name(), name + " must not null", "");
		}
	}
	...
	public static void needNotNullOrEmpty(String argument, String name) {
		...
		if (argument.isEmpty()) {
			throw new ServiceException(ExceptionCodeEnum.ILLEGAL_ARGUMENT.name(), name + " must not null or empty", "");
		}
	}
	...
	public static void needExist(File argument, String name) {
		needNotNull(argument, name);
		if (!argument.exists()) {
			throw new ServiceException(ExceptionCodeEnum.ILLEGAL_ARGUMENT.name(), name + " must exist", "");
		}
	}
	...
	public static void needIsFile(File argument, String name) {
		...
		if (!argument.isFile()) {
			throw new ServiceException(ExceptionCodeEnum.ILLEGAL_ARGUMENT.name(), name + " must be file", "");
		}
	}
	...
	public static void needIsDirectory(File argument, String name) {
		...
		if (!argument.isDirectory()) {
			throw new ServiceException(ExceptionCodeEnum.ILLEGAL_ARGUMENT.name(), name + " must be directory", "");
		}
	}
	...
	public static void needDirectoryNotEmpty(File argument, String name) {
		...
		if (fileArray.length == 0) {
			throw new ServiceException(ExceptionCodeEnum.ILLEGAL_ARGUMENT.name(), name + " must not empty", "");
		}
	}
	...
	public static void needDirectoryHasFile(File argument, String name) {
		...
		if (fileList.isEmpty()) {
			throw new ServiceException(ExceptionCodeEnum.ILLEGAL_ARGUMENT.name(), "No files in the directory", "");
		}
	}
